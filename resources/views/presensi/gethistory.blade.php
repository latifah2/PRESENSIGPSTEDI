    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{{ asset('public/upload/absensi/'.$item->foto_in) }}" target="_blank">{{ $item->foto_in }}</a></td>
                <td><a href="{{ asset('public/upload/absensi/'.$item->foto_out) }}" target="_blank">{{ $item->foto_out }}</a></td>
            </tr>
            @endforeach
